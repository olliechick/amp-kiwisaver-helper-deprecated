...
**NOTE**: The AMP website has been updated since I wrote this tool, so you can no longer download the PDF needed to use it.
You can now download a CSV of all your transactions (by clicking your KiwiSaver account, then Transactions), so I will be updating it at some point to use that CSV.
